...
| MTU       | :white_check_mark: |        :white_check_mark:        | :white_check_mark: | :white_check_mark: | :white_check_mark: |        :x:         |        :x:         | :x:                |
|           |                    |                    |                    |                    |                    |                    |                    |                    |
| MVP ^^^   |                    |                    |                    |                    |                    |                    |                    |                    |
|           |                    |                    |                    |                    |                    |                    |                    |                    |
...
| ----- | ------------------ | ---- | ---- | ------------------ | ---- | ---- | ------------------ | ---- | ---- | ---- | ---- | ------ |
| Works | :white_check_mark: | :x:  | :x:  | :white_check_mark: | :x:  | :x:  | :white_check_mark: | :x:  | :x:  | :x:  | :x:  | :x:    |
